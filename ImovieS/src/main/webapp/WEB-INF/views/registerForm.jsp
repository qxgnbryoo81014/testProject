...
<!--                                 	</p> -->
        ...
        <script type="text/javascript">
        	function inputMember() {
				//alert("fuck");
				$("input[name='memberId']").val("eeit114");//帳號
				$("input[name='name']").val("李榮號");//姓名
				$("input[name='email']").val("eeit114@gmail.com");//Email
				$("input[name='password']").val("qaz7788569");//密碼
				$("input[name='password1']").val("qaz7788569");//再次確認您的密碼
				$("input[name='address']").val("台北市萬華區峨嵋街16號2樓");//地址
				$("input[name='tel']").val("0938679671");//電話
			}
        </script>
</body>
</html>